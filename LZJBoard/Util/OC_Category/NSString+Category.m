...
+ (NSString *)timeStamp
{
    ...
    return [NSString stringWithFormat:@"%lld", (long long)[datenow timeIntervalSince1970InMilliSecond]];
}
...
+ (NSString *)formatPriceWithPrice:(double)price
{
    ...
    if (price) {
        ...
        if (price >= 1000000) {
            string = [NSString stringWithFormat:@"￥%0.0f万", price / 10000];
        } else {
            NSString *priceS = [self formatPriceWithFloatWhenNoFloat:price];
            string = [NSString stringWithFormat:@"￥%@",priceS];
        }
...
+ (NSString *) formatPriceWithFloat:(double)price
{
    ...
    NSString *string = [formatter stringFromNumber:[NSNumber numberWithDouble:price]];
...
+ (NSString *) formatPriceWithFloatWhenNoFloat:(double)price
{
    ...
    NSInteger priceInt = [[NSString stringWithFormat:@"%0.2f", price] integerValue];
    NSString *printIntString = [NSString stringWithFormat:@"%d", (int)[[NSString stringWithFormat:@"%0.2f", price] integerValue]];
    
    if (price - priceInt > 0) {
        return stringFloat;
    }
    return printIntString;
}
